...
knitr::opts_knit$set(root.dir = '/Users/pauljeffries/Desktop/personal/personal_code/text_analysis_r/')
```
...
Here we can see that the dataframe that we care about is dataframe number 9, as it is the only one that contains the column name "is_from_me".
