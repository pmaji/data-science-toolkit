---
title: "kNN for a Geometric Morphometric Application"
author: "William Bell"
date: '2018-09-10'
...
print(Actual = ProportionPredictedCorrectlyNN1, Predicted = NullExpectedCorrectPredictions)

```

This is slightly slower (exactly 3/4s), but as to be expected, with an increased true positive rate for males, there is a higher false negative rate for females.
